"""
Calculations provided by aiida_nims_scheduler.
...
class DiffCalculation(CalcJob):
    ...
    def define(cls, spec):
        ...
        spec.inputs['metadata']['options']['parser_name'].default = 'nims_scheduler'
        ...
        spec.output('nims_scheduler', valid_type=SinglefileData, help='diff between file1 and file2.')
