# -*- coding: utf-8 -*-
#
# Sphinx configuration for aiida-nims-scheduler
#
...
project = u'aiida-nims-scheduler'
...
release = aiida_nims_scheduler.__version__
...
html_use_opensearch = 'http://aiida-nims-scheduler.readthedocs.io'
...
htmlhelp_basename = 'aiida-nims-scheduler-doc'
